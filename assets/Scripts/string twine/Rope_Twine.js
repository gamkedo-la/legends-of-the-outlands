...
private var twineRenderer : GameObject;
private var line : TwineRenderer;
...
function BuildRope()
{
	twineRenderer = new GameObject("TwineRenderer_" + gameObject.name);
	line = twineRenderer.AddComponent(TwineRenderer);
